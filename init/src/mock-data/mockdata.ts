...
export class MockData {
     ...
     * this module. Data is deleted in the order based on the table
    ...
    private async writeDeployments(
      ...
      for (const env of envs) {
        ...
        switch (env) {
          case 'Dev':
            timeInEnv = appId === 'App 1' ? 0.5 : 1;
            break;
          case 'QA':
            timeInEnv = 1;
            break;
          case 'Staging':
            timeInEnv = appId === 'App 1' ? 1 : 3;
            break;
          default:
            timeInEnv = 0;
        }
        deploymentTime = deploymentTime.plus({days: timeInEnv});
